...
namespace AuctionService.Data
{
    public class AuctionDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                new Auction { Id = Guid.Parse("afbee524-5972-4075-8800-7d1f9d7b0a0c"), Status = Status.Live, ReservePrice = 20000, Seller = "bob", AuctionEnd = new DateTime(2025, 10, 10), ItemId = items[0].Id},
                new Auction { Id = Guid.Parse("c8c3ec17-01bf-49db-82aa-1ef80b833a9f"), Status = Status.Live, ReservePrice = 90000, Seller = "alice", AuctionEnd = new DateTime(2025, 8, 30), ItemId = items[1].Id },
                new Auction { Id = Guid.Parse("bbab4d5a-8565-48b1-9450-5ac2a5c4a654"), Status = Status.Live, Seller = "bob", AuctionEnd = new DateTime(2025, 7, 22), ItemId = items[2].Id},
                ...
                new Auction { Id = Guid.Parse("47111973-d176-4feb-848d-0ea22641c31a"), Status = Status.Finished, ReservePrice = 150000, Seller = "alice", AuctionEnd = new DateTime(2025, 5, 13), ItemId = items[6].Id},
                new Auction { Id = Guid.Parse("6a5011a1-fe1f-47df-9a32-b5346b289391"), Status = Status.Live, Seller = "bob", AuctionEnd = new DateTime(2025, 9, 19), ItemId = items[7].Id },
                new Auction { Id = Guid.Parse("40490065-dac7-46b6-acc4-df507e0d6570"), Status = Status.Finished, ReservePrice = 20000, Seller = "tom", AuctionEnd = new DateTime(2025, 5, 20), ItemId = items[8].Id},
                new Auction { Id = Guid.Parse("3659ac24-29dd-407a-81f5-ecfe6f924b9b"), Status = Status.Finished, ReservePrice = 20000, Seller = "bob", AuctionEnd = new DateTime(2025, 6, 1), ItemId = items[9].Id }
            };
